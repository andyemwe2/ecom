...
class Product extends CI_Controller {
    ...
    public function invoice()
    {
        ...
        $this->data['title']   = 'Majoo Teknologi Indonesia';
        $this->data['isi']     = 'Invoice_v';
        $this->data['products'] = $this->M_product->invoice_all();
        $this->load->view('Layout/tema', $this->data);
        }
    }
    ...
    public function buy(){
        ...
        $this->M_product->buy($data,$id);
        $this->session->set_flashdata('notif','<div class="alert alert-success" role="alert"> Data Berhasil Terinput, terimakasih telah membeli <button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button></div>');
        redirect('');
    }
}